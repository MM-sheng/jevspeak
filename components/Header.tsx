...
export function Header({
  ...
  return (
    <header className="flex items-center justify-between border-b-[1.5px] border-ink bg-paper px-3 h-11 shrink-0 gap-3">
      ...
      <div className="flex items-center gap-2 min-w-0 overflow-x-auto [scrollbar-width:none] py-1">
        {mode && (
          <span
            className={`mono text-[11px] px-1.5 py-[2px] border-[1.5px] border-ink whitespace-nowrap ${mode === "api" ? "bg-ink text-white" : "bg-pink text-ink"}`}
